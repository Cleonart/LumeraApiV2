...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2020 at 08:28 AM
...
('1c272047233576d77a9b9a1ac', 'Jane Doe', 'jane', 'jane', 'Hair Washer', 1, 'NULL', 'NULL'),
('2', 'Mimin', 'mimin', 'mimin', 'Stylist', 1, 'NULL', 'NULL'),
('3152b3ea97e57ab112e0c970f', 'Ganteng', 'ganteng', '051099', 'Stylist', 1, 'NULL', 'NULL');
...
('102-1587746233204575', '2020-06-08', 750000, 'Produk', 0, '', 'NULL', 'NULL'),
('102-1587916744774890', '2020-06-20', 750000, 'Produk', 1, '', 'NULL', 'NULL'),
('102-1592623384063707', '2020-06-20', 750000, 'Produk', 0, '', 'NULL', 'NULL'),
('180-1587923468272727', '2020-04-26', 100000, 'Inventaris', 1, '', 'NULL', 'NULL'),
('180-1587923735553405', '2020-05-24', 800000, 'Inventaris', 1, '', 'NULL', 'NULL');
...
--
ALTER TABLE `purchase_detail`
  MODIFY `purchase_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
