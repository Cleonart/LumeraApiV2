<?php
	...
	if(isset($_GET['id'])){
		...
		$data = $dale->kueri("SELECT * FROM `master_services` ORDER BY 	`services_category` DESC,`services_name` ASC  ");
	}
	...
	if(isset($_GET['id'])){
		...
		// table header
		$json_header = [];
		$json_header[0] = "ID Service";
		$json_header[1] = "Nama Service";
		$json_header[2] = "Harga";
		$json_header[3] = "Kategori";
